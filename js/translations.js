const translations = {
    hu: {
        ...
        purchase: "Vásárlás",
        aboutTitle: "Rólam",
        aboutText1: "Szenvedélyes művész vagyok, aki a természet és az absztrakt művészet határán alkot. Minden festményem egy egyedi történetet mesél el, amely a néző képzeletét és érzelmeit hivatott megmozgatni.",
        aboutText2: "Művészetem középpontjában a színek és formák harmóniája áll, amelyek együtt egy különleges vizuális élményt teremtenek.",
    ...
    en: {
        ...
        purchase: "Purchase",
        aboutTitle: "About Me",
        aboutText1: "I am a passionate artist who creates at the intersection of nature and abstract art. Each of my paintings tells a unique story that aims to move the viewer's imagination and emotions.",
        aboutText2: "My art centers around the harmony of colors and forms, which together create a special visual experience.",
